    ...
    return [
        {
            ...
            "content": (
                ...
                "access. Consensus is not correctness: evaluate the stated goal "
                "and constraints, evidence quality, risks/unknowns, and reversibility. "
                "Support every verifiable factual claim with a source URL, file:line, "
                "test/command result, or specific message id; otherwise label it "
                "inference or unknown. Opinions need reasoning, not fake citations. "
                "The runner will post your answer. The server owns the "
